...
document.body.dataset.thinkioViewReady = "task-kanban";
window.addEventListener("click", () => {
  vscode?.postMessage?.({ requestId: `task-kanban-${Date.now()}`, command: "plugin.select-record", payload: { source: "task-kanban" } });
});
