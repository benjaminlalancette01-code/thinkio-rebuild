...
document.body.dataset.thinkioViewReady = "runtime-node-diagram";
window.addEventListener("click", () => {
  vscode?.postMessage?.({ requestId: `runtime-node-diagram-${Date.now()}`, command: "plugin.open-record", payload: { source: "runtime-node-diagram" } });
});
