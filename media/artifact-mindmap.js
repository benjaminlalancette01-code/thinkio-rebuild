...
document.body.dataset.thinkioViewReady = "artifact-mindmap";
window.addEventListener("click", () => {
  vscode?.postMessage?.({ requestId: `artifact-mindmap-${Date.now()}`, command: "plugin.select-record", payload: { source: "artifact-mindmap" } });
});
